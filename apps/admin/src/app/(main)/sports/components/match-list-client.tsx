...
import { useGetMatches } from '@/lib/api/sport/getMatches';
...
const STATUS_OPTIONS = [
  ...
  { value: MatchStatus.Over, label: 'Over' },
  { value: MatchStatus.Postpond, label: 'Postpond' },
];
...
export default function MatchesClient(props: Props) {
  ...
  const { offset, type, status } = props;
  ...
  }, [localTopic, localStatus, searchParams, currentOffset]);
