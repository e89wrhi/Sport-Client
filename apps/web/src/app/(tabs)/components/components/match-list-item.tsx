...
export function MatchesItem({ item, onClick }: MatchCardProps) {
  ...
  return (
    <Card
      ...
      className="group relative border-none p-4 rounded-4xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer border-border/50 bg-card hover:bg-accent/5"
    >
